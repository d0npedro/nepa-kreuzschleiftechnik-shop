...
const products: ProductSeed[] = [
  // ---- Honleisten --------------------------------------------------------
  {
    ...
    images: ["/images/products/honleiste-cbn-75.jpg"],
  ...
  },
  {
    ...
    stock: 30,
    categorySlug: "honleisten",
    images: ["/images/products/honleiste-diamant-50.jpg"],
  ...
  },
  {
    ...
    stock: 85,
    categorySlug: "honleisten",
    images: ["/images/products/honleiste-sic-100.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [
      "sunnen-mbb-1660",
  ...
  },
  {
    ...
    stock: 12,
    categorySlug: "honleisten",
    images: ["/images/products/honleiste-korund-60-used.jpg"],
    isUsed: true,
    isB2BOnly: false,
    machineSlugs: [
      "sunnen-mbc-1804",
  ...
  // ---- Honwerkzeuge ------------------------------------------------------
  {
    ...
    images: ["/images/products/einlippen-honwerkzeug-25-40.jpg"],
  ...
  },
  {
    ...
    stock: 10,
    categorySlug: "honwerkzeuge",
    images: ["/images/products/mehrleisten-honwerkzeug-50-80.jpg"],
  ...
  },
  {
    ...
    stock: 8,
    categorySlug: "honwerkzeuge",
    images: ["/images/products/plateau-honwerkzeug-60-100.jpg"],
    isUsed: false,
    isB2BOnly: true,
    machineSlugs: [
      "sunnen-ml-2000",
  ...
  },
  {
    ...
    stock: 22,
    categorySlug: "honwerkzeuge",
    images: ["/images/products/kurzhub-honwerkzeug-8-15.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [
      "sunnen-sv-10",
  ...
  // ---- Schleifmittel -----------------------------------------------------
  {
    ...
    images: ["/images/products/honoel-nepa-cut-32.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  {
    ...
    stock: 100,
    categorySlug: "schleifmittel",
    images: ["/images/products/diamantpaste-6um.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  {
    ...
    stock: 75,
    categorySlug: "schleifmittel",
    images: ["/images/products/schleifleinen-k400.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  {
    ...
    stock: 50,
    categorySlug: "schleifmittel",
    images: ["/images/products/laepp-paste-sic-k600.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  ...
  // ---- Diamantwerkzeuge --------------------------------------------------
  {
    ...
    images: ["/images/products/diamant-abrichtstift-1ct.jpg"],
  ...
  },
  {
    ...
    stock: 35,
    categorySlug: "diamantwerkzeuge",
    images: ["/images/products/diamant-honahle-4mm.jpg"],
    isUsed: false,
    isB2BOnly: false,
  ...
  },
  {
    ...
    stock: 15,
    categorySlug: "diamantwerkzeuge",
    images: ["/images/products/pkd-honleiste-80.jpg"],
  ...
  },
  {
    ...
    stock: 8,
    categorySlug: "diamantwerkzeuge",
    images: ["/images/products/diamant-schleifstift-6mm-used.jpg"],
    isUsed: true,
    isB2BOnly: false,
    machineSlugs: [],
  },
  ...
  // ---- Ersatzteile -------------------------------------------------------
  {
    ...
    images: ["/images/products/zustellkegel-sunnen.jpg"],
    isUsed: false,
    isB2BOnly: false,
  ...
  },
  {
    ...
    stock: 12,
    categorySlug: "ersatzteile",
    images: ["/images/products/spindelaufnahme-hsk-a63.jpg"],
  ...
  },
  {
    ...
    stock: 65,
    categorySlug: "ersatzteile",
    images: ["/images/products/druckfeder-satz-nagel.jpg"],
    isUsed: false,
    isB2BOnly: false,
  ...
  },
  {
    ...
    stock: 30,
    categorySlug: "ersatzteile",
    images: ["/images/products/fuehrungsleiste-bronze-kadia.jpg"],
    isUsed: false,
    isB2BOnly: false,
  ...
  // ---- Zubehör -----------------------------------------------------------
  {
    ...
    images: ["/images/products/rauheits-vergleichsmuster.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  {
    ...
    stock: 15,
    categorySlug: "zubehoer",
    images: ["/images/products/innenmessschraube-50-75.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
  {
    ...
    stock: 5,
    categorySlug: "zubehoer",
    images: ["/images/products/kuehlmittel-mischanlage-60l.jpg"],
    isUsed: false,
    isB2BOnly: true,
    machineSlugs: [],
  },
  {
    ...
    stock: 35,
    categorySlug: "zubehoer",
    images: ["/images/products/magnetfilter-einsatz.jpg"],
    isUsed: false,
    isB2BOnly: false,
    machineSlugs: [],
  },
